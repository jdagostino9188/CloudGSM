...
if (gameMode == 1) then
	...
	if (worldName == "Takistan") then
	    {
	    _mrkCSAT = ["airport_1","puesto_1","control_10","control_13","resource","resource_9","factory"];
	    _controlesNATO = _controlesNATO - ["control"];
	    _controlesCSAT = ["control_10","control_13"];
	    }
	else
	    {
